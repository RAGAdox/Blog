...
const PrivacyPolicy = () => (
  <>
    <h1>Privacy Policy for RAGAdox</h1>

    <p>
      At TechieBloger, accessible from blogs.ragadox.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that are collected and recorded by
      TechieBloger and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in TechieBloger. This policy is not applicable to any
    ...
    <p>
      TechieBloger follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, TechieBloger uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertising partners of TechieBloger.
    </p>

    <p>
      Third-party ad servers or ad networks use technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on TechieBloger, which are sent
    ...
    <p>
      Note that TechieBloger has no access to or control over these cookies that
    ...
    <p>
      TechieBloger's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      TechieBloger does not knowingly collect any Personal Identifiable
